...
interface NFAToRegexViewProps {
  graph: AutomataGraph
  result: { regex: string } | null
}

/**
 * Displays the state elimination result for NFA → RegEx conversion.
 */
export function NFAToRegexView({ graph, result }: NFAToRegexViewProps) {
  return (
